...
public class miPerfil extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener {
    ...
    String usuario, edad, contrasena;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                    usuario = (String)dataSnapshot.child(firebaseAuth.getUid()).child("nombre").getValue();
                    tNombre.setText(usuario);
                    Log.v("tmz", "" + usuario);   //gives the value for given keyname
            }
